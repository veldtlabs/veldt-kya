...
_factory: Optional[SessionFactoryFn] = None
_warned_missing: bool = False


def set_session_factory(factory: Optional[SessionFactoryFn]) -> None:
...
def _try_platform_default() -> Optional[SessionFactoryFn]:
