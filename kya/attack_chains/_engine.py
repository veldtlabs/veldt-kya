...
def default_signal_emitter(
    ...
    try:
        ...
        return
    try:
        # allow_create=True is safe here. principal_id comes from
        # per-(tenant, principal_id) state in the chain matcher,
        # which itself is fed by evidence rows the system wrote
